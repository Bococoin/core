...
```bash
go test -v --bench github.com/Bococoin/core/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/Bococoin/core/crypto/keys/mintkey
...
PASS
ok  	github.com/Bococoin/core/crypto/keys/mintkey	12.093s
```
