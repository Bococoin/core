...
var (
	coinsPos   = sdk.NewCoins(sdk.NewInt64Coin(boco.DefaultDenom, 1000))
	coinsZero  = sdk.NewCoins()
	coinsMulti = sdk.NewCoins(sdk.NewInt64Coin(boco.DefaultDenom, 1000), sdk.NewInt64Coin("foo", 10000))
...
func TestMsgDepositGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"cosmos-sdk/MsgDeposit","value":{"amount":[{"amount":"1000","denom":"ubcc"}],"depositor":"cosmos1v9jxgu33kfsgr5","proposal_id":"0"}}`
