...
import (
	...
	keep "github.com/Bococoin/core/x/gov/keeper"
...
func TestTickExpiredDepositPeriod(t *testing.T) {
	...
	newProposalMsg := NewMsgSubmitProposal(
		...
		sdk.Coins{sdk.NewInt64Coin(boco.DefaultDenom, 5)},
		input.addrs[0],
	)
...
func TestTickPassedDepositPeriod(t *testing.T) {
	...
	newDepositMsg := NewMsgDeposit(input.addrs[1], proposalID, sdk.Coins{sdk.NewInt64Coin(boco.DefaultDenom, 5)})
...
func TestTickPassedVotingPeriod(t *testing.T) {
	...
	proposalCoins := sdk.Coins{sdk.NewCoin(boco.DefaultDenom, sdk.TokensFromConsensusPower(5))}
