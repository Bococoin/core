...
func TestDeposits(t *testing.T) {
	...
	fourStake := sdk.NewCoins(sdk.NewCoin(boco.DefaultDenom, sdk.TokensFromConsensusPower(4)))
	fiveStake := sdk.NewCoins(sdk.NewCoin(boco.DefaultDenom, sdk.TokensFromConsensusPower(5)))
