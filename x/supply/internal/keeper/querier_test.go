...
import (
	...
	keep "github.com/Bococoin/core/x/supply/internal/keeper"
...
func TestNewQuerier(t *testing.T) {
	...
	supplyCoins := sdk.NewCoins(
		sdk.NewCoin(boco.DefaultDenom, sdk.NewInt(100)),
	...
	querySupplyParams := types.NewQuerySupplyOfParams(boco.DefaultDenom)
