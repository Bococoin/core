...
import (
	...
	vestingtypes "github.com/Bococoin/core/x/auth/vesting/types"
...
const (
	...
	MinBocoConnectAmount   = "min_boco_connect_amount"
)
...
func GenMinBocoConnectAmount(r *rand.Rand) int64 {
	return int64(simulation.RandIntBetween(r, 1, 100))
}
...
func RandomGenesisAccounts(simState *module.SimulationState) (genesisAccs exported.GenesisAccounts) {
	for i, acc := range simState.Accounts {
		coins := sdk.Coins{sdk.NewCoin(boco.DefaultDenom, sdk.NewInt(simState.InitialStake))}
