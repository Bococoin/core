...
type BaseAccount struct {
	...
	Parent        sdk.AccAddress `json:"parent" yaml:"parent"`
}
...
// SetParent assign parent account for Boco structure
func (acc *BaseAccount) SetParent(parent sdk.AccAddress) error {
	if parent != nil && bytes.Equal(acc.Address.Bytes(), parent.Bytes()) {
		return errors.New("parent can not points to himself")
	}
	acc.Parent = parent
	return nil
}

// GetParent returns parent account address of account
func (acc *BaseAccount) GetParent() sdk.AccAddress {
	return acc.Parent
}
...
func (acc BaseAccount) Validate() error {
	...
	if acc.Parent != nil && acc.Address != nil &&
		bytes.Equal(acc.Address.Bytes(), acc.Parent.Bytes()) {
		return errors.New("parent can not points to himself")
	}
	return nil
}
