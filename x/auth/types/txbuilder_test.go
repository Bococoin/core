	...
	tests := []struct {
	...
	}{
		{
			...
			fields{
				...
				Fees:          sdk.NewCoins(sdk.NewCoin(boco.DefaultDenom, sdk.NewInt(1))),
			},
			defaultMsg,
			StdSignMsg{
				ChainID:       "test-chain",
				...
				Memo:          "hello from Voyager 1!",
				Msgs:          defaultMsg,
				Fee:           NewStdFee(200000, sdk.Coins{sdk.NewCoin(boco.DefaultDenom, sdk.NewInt(1))}),
			},
			false,
		},
		{
			...
			fields{
				...
				GasPrices:     sdk.DecCoins{sdk.NewDecCoinFromDec(boco.DefaultDenom, sdk.NewDecWithPrec(10000, sdk.Precision))},
			},
			defaultMsg,
			StdSignMsg{
				ChainID:       "test-chain",
