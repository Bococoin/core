...
func TestNewBaseVestingAccount(t *testing.T) {
	...
	_, err := NewBaseVestingAccount(
		...
		sdk.Coins{sdk.NewInt64Coin(boco.DefaultDenom, 50)}, 100,
	)
	require.Equal(t, errors.New("vesting amount cannot be greater than total amount"), err)

	_, err = NewBaseVestingAccount(
		authtypes.NewBaseAccount(addr, sdk.NewCoins(sdk.NewInt64Coin(boco.DefaultDenom, 10)), pubkey, 0, 0),
		sdk.Coins{sdk.NewInt64Coin(boco.DefaultDenom, 50)}, 100,
	)
	require.Equal(t, errors.New("vesting amount cannot be greater than total amount"), err)
	...
	_, err = NewBaseVestingAccount(
		authtypes.NewBaseAccount(addr, sdk.Coins{sdk.NewInt64Coin(boco.DefaultDenom, 50)}, pubkey, 0, 0),
		sdk.Coins{sdk.NewInt64Coin(boco.DefaultDenom, 50)}, 100,
	)
...
func TestGenesisAccountValidate(t *testing.T) {
	...
	baseAccWithCoins.SetCoins(sdk.Coins{sdk.NewInt64Coin(boco.DefaultDenom, 50)})
	...
	tests := []struct {
		...
		},
		{
			...
			NewPeriodicVestingAccount(baseAccWithCoins, 0, Periods{Period{Length: int64(100), Amount: sdk.Coins{sdk.NewInt64Coin(boco.DefaultDenom, 50)}}}),
			nil,
		},
		{
			...
			NewPeriodicVestingAccountRaw(
				baseVestingWithCoins,
				0, Periods{Period{Length: int64(50), Amount: sdk.Coins{sdk.NewInt64Coin(boco.DefaultDenom, 50)}}}),
		...
		},
		{
			...
			NewPeriodicVestingAccountRaw(
				baseVestingWithCoins,
				0, Periods{Period{Length: int64(100), Amount: sdk.Coins{sdk.NewInt64Coin(boco.DefaultDenom, 25)}}}),
