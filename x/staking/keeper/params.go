...
func (k Keeper) MinSelfDelegation(ctx sdk.Context) (res int64) {
	k.paramstore.Get(ctx, types.KeyMinValidatorSelfDelegation, &res)
	return
}

func (k Keeper) IsDelegateEnabled(ctx sdk.Context) (res bool) {
	k.paramstore.Get(ctx, types.KeyDelegateEnabled, &res)
	return
}
