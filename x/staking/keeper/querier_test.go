...
func TestQueryDelegation(t *testing.T) {
	...
	require.Equal(t, sdk.NewCoin(boco.DefaultDenom, delegation.Shares.TruncateInt()), delegationRes.Balance)
	...
	require.Equal(t, sdk.NewCoin(boco.DefaultDenom, delegation.Shares.TruncateInt()), delegatorDelegations[0].Balance)
	...
	require.Equal(t, sdk.NewCoin(boco.DefaultDenom, delegation.Shares.TruncateInt()), delegationsRes[0].Balance)
