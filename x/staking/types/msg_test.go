...
var (
	coinPos  = sdk.NewInt64Coin(boco.DefaultDenom, 1000)
	coinZero = sdk.NewInt64Coin(boco.DefaultDenom, 0)
)
...
func TestMsgBeginRedelegate(t *testing.T) {
	tests := []struct {
		...
		{"regular", sdk.AccAddress(valAddr1), valAddr2, valAddr3, sdk.NewInt64Coin(boco.DefaultDenom, 1), true},
		{"zero amount", sdk.AccAddress(valAddr1), valAddr2, valAddr3, sdk.NewInt64Coin(boco.DefaultDenom, 0), false},
		{"empty delegator", sdk.AccAddress(emptyAddr), valAddr1, valAddr3, sdk.NewInt64Coin(boco.DefaultDenom, 1), false},
		{"empty source validator", sdk.AccAddress(valAddr1), emptyAddr, valAddr3, sdk.NewInt64Coin(boco.DefaultDenom, 1), false},
		{"empty destination validator", sdk.AccAddress(valAddr1), valAddr2, emptyAddr, sdk.NewInt64Coin(boco.DefaultDenom, 1), false},
	}
...
func TestMsgUndelegate(t *testing.T) {
	tests := []struct {
		...
		{"regular", sdk.AccAddress(valAddr1), valAddr2, sdk.NewInt64Coin(boco.DefaultDenom, 1), true},
		{"zero amount", sdk.AccAddress(valAddr1), valAddr2, sdk.NewInt64Coin(boco.DefaultDenom, 0), false},
		{"empty delegator", sdk.AccAddress(emptyAddr), valAddr1, sdk.NewInt64Coin(boco.DefaultDenom, 1), false},
		{"empty validator", sdk.AccAddress(valAddr1), emptyAddr, sdk.NewInt64Coin(boco.DefaultDenom, 1), false},
	}
